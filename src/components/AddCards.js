                        ...
                        <div className="modal-content card-glass">
                            ...
                            <div className="modal-footer">
                                <div className='d-flex me-auto' style={{ width: '100%' }}  >
                                    <textarea style={{ width: 'inherit' }} className=" d-flex form-control-plaintext" id="modaltags" name='tags' placeholder='Tags' value={props.tags} rows="2" onChange={handleOnChange} ></textarea>
                                </div>
